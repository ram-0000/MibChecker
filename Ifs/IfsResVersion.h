...
public:
	...
	inline QString Comments(const QString & CodePage = "") const { return String("Comments", CodePage); }
	inline QString CompanyName(const QString & CodePage = "") const { return String("CompanyName", CodePage); }
	inline QString FileDescription(const QString & CodePage = "") const { return String("FileDescription", CodePage); }
	inline QString FileVersion(const QString & CodePage = "") const { return String("FileVersion", CodePage); }
	inline QString InternalName(const QString & CodePage = "") const { return String("InternalName", CodePage); }
	inline QString LegalCopyright(const QString & CodePage = "") const { return String("LegalCopyright", CodePage); }
	inline QString LegalTrademarks(const QString & CodePage = "") const { return String("LegalTrademarks", CodePage); }
	inline QString OriginalFilename(const QString & CodePage = "") const { return String("OriginalFilename", CodePage); }
	inline QString PrivateBuild(const QString & CodePage = "") const { return String("PrivateBuild", CodePage); }
	inline QString ProductName(const QString & CodePage = "") const { return String("ProductName", CodePage); }
	inline QString ProductVersion(const QString & CodePage = "") const { return String("ProductVersion", CodePage); }
	inline QString SpecialBuild(const QString & CodePage = "") const { return String("SpecialBuild", CodePage); }
